        ...
        return (
            <div className={classes.root}>
                ...
                <Dialog
                    ...
                    <DialogContent>
                        <DialogContentText>
                            TODO: Some helper text here about how you can
                            recover your password lorem ipsum dolor sit amet
                            consectitur somethingsomething i dont speak fake
                            latin
                        </DialogContentText>
                    </DialogContent>
                    <DialogActions>
                        <Button variant="raised" color="primary">
                            <Link to="/">Link to nowhere right now</Link>
                        </Button>
                    </DialogActions>
                </Dialog>
            </div>
